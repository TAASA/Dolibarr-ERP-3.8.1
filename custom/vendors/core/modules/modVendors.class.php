	...
	public function __construct($db)
	{
        ...
        */
		...
		$this->menu[$r]=array(	'fk_menu'=>'',			                // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
									...
									'titre'=>'Vendors top menu',
									'mainmenu'=>'vendors',
									'leftmenu'=>'vendors',
									'url'=>'/vendors/pagetop.php',
									'langs'=>'mylangfile@vendors',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
		...
		//							'titre'=>'Vendors left menu',
		//							'mainmenu'=>'xxx',
		//							'leftmenu'=>'vendors',
		//							'url'=>'/vendors/pagelevel2.php',
		//							'langs'=>'mylangfile@vendors',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
